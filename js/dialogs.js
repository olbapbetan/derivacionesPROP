...
dPrems.but = document.createCosa (
    ...
    "type", "button", 
    "name", "btnHip",
    "onclick", "setPremisas( dPrems.inp.value )");
...
dConc.but = document.createCosa (
    ...
    "type", "button", 
    "name", "btnConc",
    "onclick", "setConclusion ( dConc.inp.value )");
...
dBoton.help = document.createCosa (
    "button", "type", "button", 
    "id", "btnHelp", 
    "onclick", "window.open ('manProp.txt')");
...
dTS.dOK = document.createCosa (
    "button","type", "button", 
    "id", "dTSdOK", 
    "onclick", "setTipoLenguaje (dTS.dSim.inp.value, dTS.dLen.inp.value)");  
