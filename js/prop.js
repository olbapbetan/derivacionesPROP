...
Formula.prototype.toAscii = function () {return this.fapply (dispFfAscii);};
Formula.prototype.toStr   = function () {return this.fapply (dispFf);};
Formula.prototype.toTex   = function () {return this.fapply (dispFfTex);};
...
{
    var ans = true, idx = 0;
    while (ans && (idx < f.hijosT.length)) 
	ans = f.hijosT[idx++].checkAridades ();
    idx = 0;
    while (ans && (idx < lst.length)) ans = lst[idx++];
    return ans && ((f.tk !== "id") || (f.hijosT.length == gNombreRelaciones [f.value]));
}
Formula.prototype.checkAridades = 
	function () {return this.fapply (Form_checkAridades);};
...
Term.prototype.disp = function () {return this.fapply (Term_disp);}

function Term_FV (t, lst)
{
    var ans = [];
    switch (t.tk) {
    case "vari": ans.push (t.value); break;
    case "cons": break;
    case "func":
...
Term.prototype.FV = function () {return this.fapply (Term_FV);};

function Term_enFV (t, lst, xargs)
{
    var x = xargs[0];
    switch (t.tk) {
    case "vari": return x == t.value;
...
Term.prototype.enFV = function (x) {return this.fapply (Term_enFV, x);};
...
function Term_sust (t, lst, xargs) 
{
    ...
    var ans;
    switch (t.tk) {
    case "vari": ans = (x == t.value ? u : t).dup (); break;
    case "cons": ans = t.dup (); break;
    case "func": ans = t.dup (); ans.hijos = lst; break;
    }
    return ans;
}
Term.prototype.sust = function (x) {return this.fapply (Term_sust, x);};
...
function Form_enFV (t, lst, xargs)
{
    ...
    case "lequ": return t.hijosT[0].enFV (xargs) || t.hijosT[1].enFV (xargs);
    case "land":
    case "lor":
    case "lthen":
    case "liff": return lst[0] || lst[1];
    case "lnot": return lst[0];
    case "lall":
    case "lexi": return (t.value != x) && lst[0];
    }
}
Formula.prototype.enFV = function (x) {return this.fapply (Form_enFV, x);};
...
function Form_sust (t, lst, xargs)
{
    ...
    case "lthen":
    case "liff": 
    case "lnot": ans.hijos = lst; break;
    case "lall": 
    case "lexi": if (x != t.value) ans.hijos = lst; break;
    case "bottom": break;
    }
    return ans;
}
Formula.prototype.sust = function (x) {return this.fapply (Form_sust, x);};
...
function Form_FV (t, lst)
{
    ...
    case "id": 
	for (var i = 0; i < t.hijosT.length; i ++)
	    ans.concat (t.hijosT[i].FV ());
	break;
    case "land":
    case "lor":
    case "lthen":
    case "liff": ans.concat (lst[0], lst[1]); break;
    case "lnot": ans.concat (lst[0]); break;
    case "lequ": ans.concat (t.hijosT[0].FV (), t.hijosT[1].FV ()); break;
    case "lall": 
    case "lexi": 
...
Formula.prototype.FV = function () {return this.fapply (Form_FV);};
...
function Form_librepara (f, lst, xargs)
{
    ...
    case "liff": return (lst[0] && lst[1]); 
    case "lnot": return lst[0];
    case "lequ": return true;
    case "lall": 
    case "lexi": return (x == f.value) || (lst[0] && !t.enFV (f.value));
    }
}
Formula.prototype.librepara 
    = function (t, x) {return this.fapply (Form_librepara,[t,x]);};
...
function Term_dup (f, lst)
{
    ...
    case "vari": 
    case "cons": break;
    case "func": ans.hijos = lst; break;
    }
    return ans;
}
Term.prototype.dup = function () {return this.fapply (Term_dup);};
...
function Form_dup (f, lst)
{
    ...
    case "lnot": ans.hijos = lst; break;
    case "lall": 
    case "lexi": ans.hijos = lst; break;
    }
    return ans;
}
Formula.prototype.dup = function () {return this.fapply (Form_dup);};
...
Term.prototype.checkAridades = 
	function () {return this.fapply (Term_checkAridades);};
